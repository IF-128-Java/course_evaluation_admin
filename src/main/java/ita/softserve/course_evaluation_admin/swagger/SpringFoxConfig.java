package ita.softserve.course_evaluation_admin.swagger;
...
import static ita.softserve.course_evaluation_admin.constants.SwaggerConstants.*;
...
public class SpringFoxConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("ita.softserve.course_evaluation_admin.controller"))
